...
class MainMenuUi(object):
    def setupUi(self, MainWindow):
        ...
        self.label_2.setPixmap(QtGui.QPixmap("data/pictures/icon1.png"))
        self.label_2.setScaledContents(True)
        self.label_2.setObjectName("label_2")
        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(570, 90, 141, 141))
        self.label_3.setText("")
        self.label_3.setPixmap(QtGui.QPixmap("data/pictures/icon2.png"))
        self.label_3.setScaledContents(True)
        self.label_3.setObjectName("label_3")
        self.label_5 = QtWidgets.QLabel(self.centralwidget)
        self.label_5.setGeometry(QtCore.QRect(560, 320, 151, 151))
        self.label_5.setText("")
        self.label_5.setPixmap(QtGui.QPixmap("data/pictures/icon4.png"))
        self.label_5.setScaledContents(True)
        self.label_5.setObjectName("label_5")
        self.label_4 = QtWidgets.QLabel(self.centralwidget)
        self.label_4.setGeometry(QtCore.QRect(70, 330, 141, 141))
        self.label_4.setText("")
        self.label_4.setPixmap(QtGui.QPixmap("data/pictures/icon5.png"))
